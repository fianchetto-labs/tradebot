...
DEFAULT_OEX_URL = "localhost:8080"
DEFAULT_QUOTES_URL = "localhost:8081"
...
class Client:
    ...
    def get_accounts(self) -> list[Account]:
        ...
        response: ListAccountsResponse = self.get(path=path, response_model=ListAccountsResponse,
    ...
    def get_account(self, account_id: str) -> Account:
        ...
        response: GetAccountResponse = self.get(path=path, response_model=GetAccountResponse, path_params=path_params, query_params=None)
    ...
    def get_portfolio(self, account_id: str)->Portfolio:
        ...
        response: GetPortfolioResponse = self.get(path=path, response_model=GetPortfolioResponse, path_params=path_params, query_params=None)
    ...
    def get_account_balance(self, account_id: str):
        ...
        response: GetAccountBalanceResponse = self.get(path=path, response_model=GetAccountBalanceResponse,
                                                  path_params=path_params, query_params=None)
    ...
    def preview_order(self, account_id: str, order: Order, client_order_id: str=None)->PreviewOrderResponse:
        ...
        response: PreviewOrderResponse = self.post(path=path, response_model=PreviewOrderResponse,
                                                  path_params=path_params, query_params=None)
        return response
    ...
    def place_order(self, account_id: str, order: Order, preview_id: str=None)->PlaceOrderResponse:
        order_metadata: OrderMetadata = OrderMetadata(order_type=order.get_order_type(),
    ...
    def get_path(self, request: Request):
        ...
        if request_type == GetOptionsChainRequest:
            req: GetOptionsChainRequest = request
            if req.expiry:
                # Inelegant but temporary hack before good solution to FIA-94
                return "/api/v1/{brokerage}/quotes/equity/{equity}/options_chain/{expiry}"
    ...
    def get(
        ...
        url = self._format_path(path, path_params)
    ...
    def _format_path(self, path: str, path_params: Optional[dict]) -> str:
        if path_params:
...
if __name__ == "__main__":
    ...
    por: PreviewOrderResponse = etrade_client.preview_order(account_id, o)
    print(por)